...
function synthesizeDeterministicStoryboard(slotArchetype, topicTitle, channelHandle = '@thestoicarchitect-n4b', slotIndex = 0) {
  const errorMsg = `[Stoic Storyboard Engine FATAL] Fallback / preset scripts are strictly removed. All storyboards must be generated by active AI inference providers (Groq, Gemini, Grok, OpenRouter, DeepSeek, OpenAI, or Cloudflare).`;
  console.error(`\n${errorMsg}\n`);
...
function synthesizeDeterministicDeepDiveStoryboard(archetype, topicTitle, channelHandle = '@thestoicarchitect-n4b') {
  const errorMsg = `[Stoic Masterclass Engine FATAL] Fallback / preset masterclass scripts are strictly removed. All 15-chapter deep dives must be generated by active AI inference providers.`;
  console.error(`\n${errorMsg}\n`);
  throw new Error(errorMsg);
}
...
module.exports = {
  ...
  synthesizeDeterministicStoicDeepDiveStoryboard: synthesizeDeterministicDeepDiveStoryboard
};
