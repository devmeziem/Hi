            ...
            <div className="p-6 bg-slate-900 border border-slate-800 rounded-3xl space-y-5">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 border-b border-slate-800 pb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">
                    Click any video poster to play the full 9:16 Short with synchronized audio, kinetic captions, and multi-slide transitions.
                  </p>
                </div>
                <button
              ...
              {savedCampaigns.length === 0 ? (
                <div className="text-center py-12 space-y-3">
                  ...
                  <p className="text-sm font-bold text-slate-400">No videos vaulted yet</p>
                  <button
